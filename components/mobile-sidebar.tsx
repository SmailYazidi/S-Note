...
import { Search, Plus, FileText, Lock, LogOut, Menu } from "lucide-react"
    ...
    <div className="md:hidden">
      <Sheet open={isOpen} onOpenChange={setIsOpen}>
        <SheetTrigger asChild>
          <Button variant="outline" size="icon" className="fixed top-4 left-4 z-40 bg-transparent">
